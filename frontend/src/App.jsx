    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <header className="bg-white shadow sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex justify-between items-center">
          <Link to="/" className="text-2xl font-bold text-blue-600 hover:text-blue-800 cursor-pointer">
            🎓 TutorKG
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            {user ? (
              <>
                <Link to="/profile" className="flex items-center gap-2 hover:bg-gray-50 px-3 py-2 rounded transition cursor-pointer">
      ...
      {/* Футер */}
           {/* Футер */}
      <footer className="bg-gray-100 border-t mt-auto py-4"> {/* ✅ Фон стал чуть темнее */}
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-2 text-sm text-gray-600">
          ...
          <div className="flex gap-4">
           <Link to="/tutor-guide" className="hover:text-blue-600 transition">Как проводить уроки</Link>
            ...
            {/* ✅ Ссылка на админку теперь видна только админу */}
            {user?.role === 'ADMIN' && (
